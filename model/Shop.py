...
class Shop(BaseModel):
    field_map = {
        ...
        'Y': 'hourRoomTimeText',
        'Z': 'userInfoUrl',
        'aA': 'isHospitalQueueable',
        'aB': 'nearbyTransport',
        'aC': 'arrived',
        'aD': 'wished',
        'aE': 'shopStatusTag',
        'aF': 'extSourceNameText',
        'aG': 'extSourceId',
        'aH': 'extSourceName',
        'aI': 'certifiedHairDresserInfo',
        'aJ': 'hasCarMoPay',
        'aK': 'bookType',
        'aL': 'isBanquetShop',
        'aM': 'isEduClassTogether',
        'aN': 'feastInfo',
        'aO': 'statusText',
        'aP': 'infraList',
        'aQ': 'viewType',
        ...
        'ah': 'hotelInfoV1',
        'ai': 'regionText',
        'aj': 'hasHotelAndSpotPackage',
        'ak': 'isRenovationSelectiveShop',
        'al': 'naviUrl',
        'am': 'containMeituan',
        'an': 'shopPositionInfo',
        'ao': 'shopExtraTags',
        'ap': 'shopStateInformation',
        'aq': 'phoneTip',
        'ar': 'recommendReason',
        'as': 'hasMeiTuanDeal',
        'at': 'shareContent',
        ...
        'bl': 'hotelInfo',
        'bm': 'overseaBigPic',
        'bn': 'overseaShopNearby',
        'bo': 'addressCard',
        'bp': 'oriName',
        'bq': 'verticalChannelBookable',
        'br': 'hasMultiPic',
        'bs': 'activity',
        'bt': 'hotelRankTag',
        'bu': 'advancedPics',
        ...
        'cD': 'mCStatus',
        'cE': 'authorityLabel',
        'cF': 'authorityLabelType',
        'cG': 'isRateFromDP',
        'cH': 'isDishMenu',
        'cI': 'shopView',
        'cJ': 'announce',
        'cK': 'shopMemberCardID',
        'cL': 'shopPhotoCategory',
        'cM': 'cooperationInfo',
        'cN': 'recommends',
        'cO': 'recommendIcon',
        'cP': 'tourist',
