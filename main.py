...
class DPRequest:
    ...
    zip = None
    id = 0
# ip.dst==36.110.144.17||ip.dst==115.159.130.100||ip.dst==103.37.153.2||ip.dst==203.195.146.48||ip.dst==203.195.145.126
    def __init__(self, des_key_b=None, des_key_t=None, des_key_a=None, localPublickey=None, localPrivate=None):
        self._ip = ["115.159.130.100", "36.110.144.17", "103.37.153.2", ]  # "203.195.146.48", "203.195.145.126"
        self.AES_key = bytes.fromhex("44374336463731413132313533454535")
        self.AES_iv = bytes.fromhex("35354339333044383237424441424644")
    ...
    def make_data(self, securePayload, flag, post_data=None, payload=True, isSecure=True):
        ...
        :param securePayload: header和url等参数
        :param flag:
        :param post_data:Post请求的数据
        :param payload:是否携带payload 一般请求都带
        :param isSecure:是否是私密请求 一般都是
        :return:
        """
